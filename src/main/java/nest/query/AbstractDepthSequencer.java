...
abstract class AbstractDepthSequencer<T> {
    ...
    public void addNextDepth(T entry) {
        currentDepth++;
        add(entry);
    }
    ...
    public void addAllNextDepth(Collection<T> newEntries) {
        currentDepth++;
        addAll(newEntries);
    }
    ...
    public abstract AbstractDepthSequencer<T> sliceByRank(int smaller, int larger);

    public abstract AbstractDepthSequencer<T> sliceByDepth(int smaller, int larger);
}
